      ...
      <form className='flex flex-col gap-4 sm:flex-row'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4'>
              <input className='w-full p-3 border border-gray-300 rounded' 
              type='file' id='images' accept='image/*' multiple /> 
              <button className='p-3 text-green-700 uppercase border border-green-700 rounded hover:shadow-lg disabled:opacity-80'>Upload
              </button>
            </div>
