...
import { FaBed, FaBath, FaMapMarkerAlt, FaShare, FaParking, FaChair } from 'react-icons/fa';
    ...
    <main>
        ...
        <div>
            ...
            flex justify-center items-center bg-slate-100'>
                <FaShare className='cursor-pointer text-slate-500'
                onClick={() => {
            ...
            <div className='flex flex-col max-w-4xl gap-4 p-3 mx-auto my-7'>
                ...
                {currentUser && listing.userRef !== currentUser._id && !contact && (
                    <button onClick={() => setContact(true)} className='p-3 text-white uppercase rounded-lg bg-slate-700 hover:opacity-95'>Contact landlord</button>
                )} 
